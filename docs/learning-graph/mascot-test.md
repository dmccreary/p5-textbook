---
title: Palette Mascot Image Test
description: Visual and pixel-level transparency and trim-border checks for all seven Palette mascot poses.
hide:
  toc
---

# Palette Mascot Image Test
