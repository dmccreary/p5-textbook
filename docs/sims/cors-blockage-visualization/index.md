---
title: "CORS Blockage Visualization"
description: "Demonstrate Cross-Origin Resource Sharing (CORS) security mechanisms, origin headers, and preflight OPTIONS checks."
quality_score: 90
image: /sims/cors-blockage-visualization/cors-blockage-visualization.png
og:image: /sims/cors-blockage-visualization/cors-blockage-visualization.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/cors-blockage-visualization/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will understand why web browsers block cross-origin requests by default and how Access-Control-Allow-Origin headers work.
