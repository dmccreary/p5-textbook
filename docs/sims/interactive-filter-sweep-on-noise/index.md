---
title: "Interactive Filter Sweep on Noise"
description: "Interactive audio filter frequency sweeper: Low-Pass, High-Pass, and Band-Pass frequency response on noise signals."
quality_score: 90
image: /sims/interactive-filter-sweep-on-noise/interactive-filter-sweep-on-noise.png
og:image: /sims/interactive-filter-sweep-on-noise/interactive-filter-sweep-on-noise.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/interactive-filter-sweep-on-noise/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will understand frequency filtering concepts (cutoff frequency, resonance Q peak, and roll-off slope).
