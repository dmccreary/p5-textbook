---
title: "Interactive Flocking Fireworks"
description: "Combine Reynolds Boids flocking rules (Separation, Alignment, Cohesion) with interactive click-triggered firework particle bursts."
quality_score: 90
image: /sims/interactive-flocking-fireworks/interactive-flocking-fireworks.png
og:image: /sims/interactive-flocking-fireworks/interactive-flocking-fireworks.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/interactive-flocking-fireworks/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will explore emergent swarm behavior combined with physical particle explosion dynamics and gravity decay.
