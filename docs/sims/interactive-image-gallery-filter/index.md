...
description: "Filter, search, and sort a responsive grid of generative artwork cards by category tags and color palettes."
quality_score: 90
image: /sims/interactive-image-gallery-filter/interactive-image-gallery-filter.png
og:image: /sims/interactive-image-gallery-filter/interactive-image-gallery-filter.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/interactive-image-gallery-filter/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will learn array filtering and DOM search query matching for generative art catalogs.
