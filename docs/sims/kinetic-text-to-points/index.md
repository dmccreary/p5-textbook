---
title: "Kinetic Text to Points"
description: "Interactive generative typography converting letter glyph points into spring-physics particles that scatter on hover and reform."
quality_score: 90
image: /sims/kinetic-text-to-points/kinetic-text-to-points.png
og:image: /sims/kinetic-text-to-points/kinetic-text-to-points.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/kinetic-text-to-points/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will learn font glyph vectorization and spring force simulation to create dynamic responsive typography.
