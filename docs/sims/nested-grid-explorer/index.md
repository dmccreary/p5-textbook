---
title: "Nested Grid Explorer"
description: "Step through 2D nested for loops visually to understand row (i) and column (j) iteration order and cell coordinate calculation."
quality_score: 90
image: /sims/nested-grid-explorer/nested-grid-explorer.png
og:image: /sims/nested-grid-explorer/nested-grid-explorer.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/nested-grid-explorer/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will master nested loop execution mechanics, loop variable scoping, and 2D spatial indexing.
