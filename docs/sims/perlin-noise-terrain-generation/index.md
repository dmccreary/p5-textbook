...
description: "Generate continuous organic heightmap terrain grids in 3D WebGL perspective using multi-octave 2D Perlin noise."
quality_score: 90
image: /sims/perlin-noise-terrain-generation/perlin-noise-terrain-generation.png
og:image: /sims/perlin-noise-terrain-generation/perlin-noise-terrain-generation.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/perlin-noise-terrain-generation/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will understand 2D noise coordinate sampling, smoothness vs white noise randomness, and isometric flying terrain meshes.
