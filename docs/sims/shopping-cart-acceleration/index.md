---
title: "Shopping Cart Acceleration"
description: "Apply interactive force vectors to a shopping cart to visualize Newton's Second Law F = m*a, acceleration, and friction."
quality_score: 90
image: /sims/shopping-cart-acceleration/shopping-cart-acceleration.png
og:image: /sims/shopping-cart-acceleration/shopping-cart-acceleration.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/shopping-cart-acceleration/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will master Newton's Second Law, net force vectors, acceleration arrows, and surface friction decay.
