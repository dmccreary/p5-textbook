...
description: "3D WebGL stage lighting simulator: adjust Ambient, Directional, and Point light intensities on metallic, normal, and specular materials."
quality_score: 90
image: /sims/stage-lighting-setup/stage-lighting-setup.png
og:image: /sims/stage-lighting-setup/stage-lighting-setup.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/stage-lighting-setup/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will understand 3D shader illumination models (ambientLight, directionalLight, pointLight) and material reflectance.
