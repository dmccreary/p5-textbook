---
title: "Stochastic L-System Tree"
description: "Generate recursive branching botanical trees with stochastic random angles, depth recursion, and wind oscillation."
quality_score: 90
image: /sims/stochastic-l-system-tree/stochastic-l-system-tree.png
og:image: /sims/stochastic-l-system-tree/stochastic-l-system-tree.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/stochastic-l-system-tree/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will understand recursive tree generation, transformation matrix push/pop stacks, and stochastic variation.
