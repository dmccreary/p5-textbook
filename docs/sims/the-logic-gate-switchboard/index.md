---
title: "The Logic Gate Switchboard"
description: "Wire up boolean logic gate switches (AND, OR, NOT, XOR, NAND) to route signals to a neon indicator sign."
quality_score: 90
image: /sims/the-logic-gate-switchboard/the-logic-gate-switchboard.png
og:image: /sims/the-logic-gate-switchboard/the-logic-gate-switchboard.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/the-logic-gate-switchboard/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will understand conditional logic, truth tables, and boolean operators (&&, ||, !).
