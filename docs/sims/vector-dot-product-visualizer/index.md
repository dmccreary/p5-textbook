---
title: "Vector Dot Product Visualizer"
description: "Rotate vector A relative to vector B to compute the dot product A · B = |A||B|cos(θ) with scalar projection and geometric angle readouts."
quality_score: 90
image: /sims/vector-dot-product-visualizer/vector-dot-product-visualizer.png
og:image: /sims/vector-dot-product-visualizer/vector-dot-product-visualizer.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/vector-dot-product-visualizer/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will master vector projection, dot product magnitude, and orthogonal perpendicularity conditions.
