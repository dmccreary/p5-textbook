---
title: "Water Hose Particle Emitter"
description: "Draggable continuous water nozzle particle emitter simulating lifespan, gravity, and elastic barrier collisions."
quality_score: 90
image: /sims/water-hose-particle-emitter/water-hose-particle-emitter.png
og:image: /sims/water-hose-particle-emitter/water-hose-particle-emitter.png
---
...
```html
<iframe src="https://dmccreary.github.io/p5-textbook/sims/water-hose-particle-emitter/main.html" width="100%" height="487px"></iframe>
```
...
- **Primary Goal:** Students will learn particle system architecture, acceleration due to gravity, and collision response vectors.
