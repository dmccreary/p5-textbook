...
# Read original
filepath = 'docs/chapters/11-vector-math-physics/index.md'
...
To do this, we need the **{concepts[0]}**. A vector is an entity that has both a magnitude (length) and a direction. In p5.js, vectors are objects that store x, y, and sometimes z components. 

You can create one using the **{concepts[1]}**. For instance, `let pos = createVector(x, y);`. 
