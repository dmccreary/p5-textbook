...
let envBtn = { x: 170, y: 15, w: 140, h: 26 };
let runBtn = { x: 320, y: 15, w: 80, h: 26 };
let clearBtn = { x: CANVAS_W - 70, y: OUTPUT_H + 8, w: 50, h: 24 };
let tabConsole = { x: EDITOR_W, y: OUTPUT_H, w: 100, h: 40 };
let tabNetwork = { x: EDITOR_W + 100, y: OUTPUT_H, w: 100, h: 40 };
